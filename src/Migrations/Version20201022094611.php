 ...
 */
final class Version20201022094611 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE basket_resource (basket_id INT NOT NULL, resource_id INT NOT NULL, INDEX IDX_D83EFBC61BE1FB52 (basket_id), INDEX IDX_D83EFBC689329D25 (resource_id), PRIMARY KEY(basket_id, resource_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
